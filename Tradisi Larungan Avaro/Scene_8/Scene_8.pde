...
void draw() {
  ...
  image(shipImg, 300, seaLevel * 1.1 - 100, shipImg.width * 0.5, shipImg.height * 0.5); // Kapal pertama
  image(shipImg, width - 600, seaLevel * 1.1 - 100, shipImg.width * 0.5, shipImg.height * 0.5); // Kapal kedua
  ...
  // Tampilkan karakter kedua (Lintang) di posisi tetap
  image(character2Img, width/2 - 300, seaLevel - 200, character2Img.width * 0.8, character2Img.height * 0.8);
  
  // Tampilkan karakter ketiga (Vita) di posisi tetap
  image(character3Img, width/2 + 50, seaLevel - 200);
}
